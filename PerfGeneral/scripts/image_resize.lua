...
-- This test validates the behaviour of hiding/showing a variety of images.
local MAX_FILLS = 100
local DELTA = 4
...
local function HideReferenceControls()
  gre.set_control_attrs("animated_image_layer.ninepatch_ref", { hidden = true })
  gre.set_control_attrs("animated_image_layer.jpg_ref", { hidden = true })
  gre.set_control_attrs("animated_image_layer.png_ref", { hidden = true })
  gre.set_control_attrs("animated_image_layer.png_noalpha_ref", { hidden = true })
end
...
local png_resize = {}
function png_resize.CBSetup(mapargs)
  CBCreateControls("animated_image_layer.png_ref", "animated_image_layer", "img_%d")
end
function png_resize.CBUpdate(mapargs, elapsedTime)
  CBUpdate(mapargs, elapsedTime)
end
function png_resize.CBTeardown(mapargs)
  ControlListTeardown(controlList)
  controlList = {}
end
sbperftest.RegisterPerfTest("image_png_resize", png_resize)

local jpg_resize = {}
function jpg_resize.CBSetup(mapargs)
  CBCreateControls("animated_image_layer.jpg_ref", "animated_image_layer", "img_%d")
end
function jpg_resize.CBUpdate(mapargs, elapsedTime)
  CBUpdate(mapargs, elapsedTime)
end
function jpg_resize.CBTeardown(mapargs)
  ControlListTeardown(controlList)
  controlList = {}
end
sbperftest.RegisterPerfTest("image_jpg_resize", jpg_resize)

local ninepatch_resize = {}
function ninepatch_resize.CBSetup(mapargs)
  CBCreateControls("animated_image_layer.ninepatch_ref", "animated_image_layer", "img_%d")
end
function ninepatch_resize.CBUpdate(mapargs, elapsedTime)
  CBUpdate(mapargs, elapsedTime)
end
function ninepatch_resize.CBTeardown(mapargs)
  ControlListTeardown(controlList)
  controlList = {}
end
sbperftest.RegisterPerfTest("image_ninepatch_resize", ninepatch_resize)
...
local function CBHideShowUpdate(mapargs, elapsedTime)
  ...
  --print("Setting hidden state")
  gre.set_data(newData)
end

local png_hideshow = {}
function png_hideshow.CBSetup(mapargs)
  CBCreateTiledControls("animated_image_layer.png_ref", "animated_image_layer", "img_%d")
end
function png_hideshow.CBUpdate(mapargs, elapsedTime)
  CBHideShowUpdate(mapargs, elapsedTime)
end
function png_hideshow.CBTeardown(mapargs)
  ControlListTeardown(controlList)
  controlList = {}
end
sbperftest.RegisterPerfTest("image_png_hideshow", png_hideshow)

local jpg_hideshow = {}
function jpg_hideshow.CBSetup(mapargs)
  CBCreateTiledControls("animated_image_layer.jpg_ref", "animated_image_layer", "img_%d")
end
function jpg_hideshow.CBUpdate(mapargs, elapsedTime)
  CBHideShowUpdate(mapargs, elapsedTime)
end
function jpg_hideshow.CBTeardown(mapargs)
  ControlListTeardown(controlList)
  controlList = {}
end
sbperftest.RegisterPerfTest("image_jpg_hideshow", jpg_hideshow)
